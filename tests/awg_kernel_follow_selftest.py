#!/usr/bin/env python3
"""Runner for tests/awg_kernel_follow_selftest.sh — the check itself is a sandboxed shell harness (it exercises update.sh /
...
sys.exit(subprocess.call(["bash", os.path.join(here, "awg_kernel_follow_selftest.sh")] + sys.argv[1:]))
