...
UPSTREAM_SHA="b3935b947acd81d95107869c8f33507f3f5c1309"   # tag v18 (its wdttServerVersion const still reads "17"); our build label: 18-2 (18 + the stale-binding fix; published 2026-09-25). Patch regenerated against it, no fuzz
