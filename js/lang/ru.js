...
export const STR = {
  ...
  "{name}: {devices} on a turn server whose build can't prove who is sending — they can't reach it.": "{name}: {devices} за turn-сервером, сборка которого не подтверждает отправителя, — им это недоступно.",
  "{name}: {devices} not connected yet — they reach it once connected.": "{name}: {devices} ещё не подключались — доступ появится после подключения.",
  ...
  "{name}: {devices} not reported by the node yet.": "{name}: {devices} — нода о них ещё не сообщила.",
