...
export const STR = {
  ...
  "reach|user + groups": "свои и группы",
  ...
  "Applies to interfaces created from now on. Interfaces set to Everyone on this node today: {n}.": "Действует для интерфейсов, созданных с этого момента. Сейчас интерфейсов с уровнем «Все на этой ноде»: {n}.",
