...
> - **Два предупреждения о неполадках, которых не было.** Узел с закреплённым исходящим адресом сообщал об ошибке каждые несколько секунд, правильно при этом маршрутизируя, а другой мог показывать «маршрутизация по хостам ухудшена» лишь потому, что режим SNI выбран до назначения интерфейсу категории — теперь оба отличают «простаивает» от «сломано».
> - **Предпросмотр цвета в настройках больше не прозрачный** — цвет наконец можно оценить на фоне той темы, где его будут читать.
> - **«Настройки → Аутентификация» снова одна панель** — два раздела в одной карточке, как на остальных экранах настроек.
<!-- WHATS-NEW:END -->
