...
- **Меняйте вход в панель** в **Settings → Authentication** (Настройки → Аутентификация) — вступает в силу немедленно. Там же включите **двухфакторную аутентификацию** (Google Authenticator) для более надёжного входа.
- **Направляйте определённые сайты через определённую страну (необязательно).** Например, отправляйте
  ...
  **Settings → Routing & Blocking** (Настройки → Маршрутизация и блокировка).
