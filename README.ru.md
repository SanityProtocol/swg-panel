...
3. **Settings → Panel URL** (Настройки → Адрес панели) — задайте адрес, по которому отдаётся страница.
   Если панель сообщает, что сервер подписок не установлен, запустите команду обновления из раздела
   [Поддержание работы](#поддержание-работы) — он поставится сам.
...
**Как забрать доступ.** Две кнопки, и разница между ними важна:
